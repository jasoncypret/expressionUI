  ...
  (function($) {
    ...
    methods = {
      ...
      _add_markup: function(options) {
        ...
        if (options.style === "tip") { iconType = 'i'; }
        if (!options.message) { options.message = ''; }
        
        markup =  '<div style="display:none;" class="notify' + options.n_class + ' text_align_' + options.text_align + ' style_' + options.style + ' position_' + options.position + ' width_' + options.width + ' invert_' + options.invert + ' loading_' + options.loading + '">';
        markup += '<div class="notify_wrap" data-icon="' + iconType + '">';
        ...
        switch(options.loading) {
          ...
          default:
            (options.style == "loading") ? markup += '<div class="progress"></div><div class="msg">' + options.message + '</div>' : markup += options.message ;
