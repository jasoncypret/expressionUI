...
(($) ->
  methods =
    ...
    _add_markup: (options) ->
      markup = undefined
      iconType = undefined
      iconType = "x"  if options.style is "error"
      iconType = "/"  if options.style is "success"
      iconType = "!"  if options.style is "tip"
      iconType = "i"  if options.style is "info"
      ...
      markup += "<div class=\"icon\">" + iconType + "</div>"  if options.icon
