  ...
  ((w, d) ->
    ...
    editsi = editsi or (userOpts) ->
      settings =
        ...
        on_placeholder_hide: jQuery.noop
        on_placeholder_show: jQuery.noop
        clear_text: jQuery.noop
      ...
      utils =
        ...
        check_select: () ->
          ...
          options =
            ...
            scroll_target: jQuery(".content_scroll")
            close_on_click: "none"
          ...
          if !sel.collapsed
            ...
            if jQuery("#text_area").hasClass('popover_target')
              jQuery("#text_area").popover "reposition_popover", options
            else
              jQuery("#text_area").popover options
          else
            jQuery("#text_area").popover 'close', options
